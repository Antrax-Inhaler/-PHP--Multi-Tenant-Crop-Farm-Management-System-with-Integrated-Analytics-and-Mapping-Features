...
<form action="" id="crop-form" method="POST">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="size_of_plantation" class="control-label">Size of Plantation (hectares)(optional)</label>
                <input name="SizeOfPlantation" id="size_of_plantation" type="number" step="0.01" class="form-control form-control-sm form-control-border" value="<?php echo isset($size_of_plantation) ? $size_of_plantation : ''; ?>">
            </div>
        </div>
    </div>
