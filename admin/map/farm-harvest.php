...
<head>
  ...
  <title>Harvest Information Map</title>
  <style>
...
<body>
  ...
  <div id="nav-header">
  <div class="flex" >
      <a href="<?php echo base_url ?>admin/?page=map/map" class="nav-link">
        <span class="icon"><i class="fas fa-map"></i></span>
        <div class="labelmap">Farm Map</div>
      </a>
      <a href="<?php echo base_url ?>admin/?page=map/farm-pestanddisease" class="nav-link ">
        <span class="icon"><i class="fas fa-bug"></i></span>
        <div class="labelmap">Pests & Diseases</div>       
      </a>
      <a href="<?php echo base_url ?>admin/?page=map/farm-harvest" class="nav-link active">
        <span class="icon"><i class="fas fa-seedling"></i></span>
        <div class="labelmap">Harvest</div>
      </a>
    </div>
    <input type="text" id="searchInput" placeholder="Search by crop name, type, harvest date, etc.">
  </div>
