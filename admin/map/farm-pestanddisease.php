...
<head>
  ...
  <style>
    /* Set map and navigation header container size */
    #map {
...
<body>
  ...
  <div id="nav-header">
    <div class="flex" >
      ...
      <a href="<?php echo base_url ?>admin/?page=map/farm-pestanddisease" class="nav-link active">
        <span class="icon"><i class="fas fa-bug"></i></span>
        <div class="labelmap">Pests & Diseases</div>       
      </a>
      <a href="<?php echo base_url ?>admin/?page=map/farm-harvest" class="nav-link">
