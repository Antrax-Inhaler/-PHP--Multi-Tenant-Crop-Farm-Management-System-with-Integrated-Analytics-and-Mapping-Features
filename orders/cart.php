            ...
            <div id="cart-list">
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <button class="btn btn-flat btn-outline-danger btn-sm rem_item"  data-id="<?= $prow['id'] ?>"><i class="fa fa-times"></i><div class="remover" >Remove</div> </button>
                                    </div>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    <div class="col-12 text-center">
                        <img src="uploads/no_items_yet.png" alt="No Orders Yet" class="img-fluid" style="max-width: 300px; margin-bottom: 20px; filter: drop-shadow(0px 0px 10px rgba(0, 0, 0, 0.5))">
                        <h2>No Items Yet</h2>
                        <h6>Add to Cart Now</h6>
                    </div>
                <?php endif; ?>
                </div>
            </div>
