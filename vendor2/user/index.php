        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <form action="" id="manage-user">    
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="logo" class="control-label">Shop Logo (Click here)</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="esignature" class="control-label">E-Signature (Click here)</label>
                            <input type="file" id="esignature" name="esignature" class="form-control form-control-sm form-control-border" onchange="displayEsignature(this,$(this))" accept="image/png">
                            <div class="progress-container">
                                <div class="progress-bar" id="esignatureProgressBar"></div>
                                <div class="progress-text" id="esignatureProgressText">0%</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 text-center">
                            <label class="control-label">Or Draw Your E-Signature Here</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="oldpassword" class="control-label">Enter Current Password to Save Changes</label>
                            <div class="input-group input-group-sm">
...
<script>
    function displayImg(input, _this) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                startFakeUpload('progressBar', 'progressText', 20000);
            }
    ...
    function displayEsignature(input, _this) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function (e) {
                $('#esignature_img').attr('src', e.target.result);
                startFakeUpload('esignatureProgressBar', 'esignatureProgressText', 20000);
            }
            reader.readAsDataURL(input.files[0]);
        } else {
    ...
    function startFakeUpload(progressBarId, progressTextId, duration) {
