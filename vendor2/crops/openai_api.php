...
define('OPENAI_API_KEY', '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');
define('OPENAI_ORGANIZATION', ''); // Optional: Add your organization ID here
define('OPENAI_PROJECT', ''); // Optional: Add your project ID here
...
function openai_api($message){
  ...
  if (!empty(OPENAI_ORGANIZATION)) {
    $headers[] = 'OpenAI-Organization: ' . OPENAI_ORGANIZATION;
  }
  
  if (!empty(OPENAI_PROJECT)) {
