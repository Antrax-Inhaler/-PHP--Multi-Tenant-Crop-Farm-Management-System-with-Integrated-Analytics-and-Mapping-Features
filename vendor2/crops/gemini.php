...
.show-chatbot1 .chatbot-toggler1 {
...
.show-chatbot1 .chatbot-toggler1 span:first-child  {
    opacity: 0;
}
.show-chatbot1 .chatbot-toggler1 span:last-child {
    opacity: 1;
}
.chatbot1 {
    position: fixed;
...
.chatbox1::-webkit-scrollbar-track {
    background: #fff;
    border-radius: 25px;
}
...
<div class="chatbot1">
    ...
    <div class="chat-input">
        <textarea placeholder="Enter a message..." spellcheck="false" required id="messageInput1"></textarea>
        <span id="sendBtn1">
...
$(document).ready(function() {
    ...
    var chatInput = $('#messageInput1');
    var sendChatBtn = $('#sendBtn1');
    ...
    chatbotToggler.click(function() {
        $('body').toggleClass('show-chatbot1');
    });

    closeBtn.click(function() {
        $('body').removeClass('show-chatbot1');
    });
 ...
 $('.question-item').click(function() {
    ...
    function sendMessage(message) {
        $('#chatbox1').append('<li class="chat outgoing"><h6>' + message + '</h6></li>');
        $('#chatbox1').append('<li class="chat incoming"><span><img src="crops/chatbot.png" alt=""></span><h6></h6></li>');
        ...
        $.ajax({
            ...
            success: function(response) {
                var lastIncoming = $('#chatbox1').children('li.chat.incoming').last();
