...
<script>
  ...
  function initMap() {
    ...
    const map = new google.maps.Map(document.getElementById("map2"), {
      ...
      center: { lat: 13.2312895125931, lng: 121.194747 } // Default location
    });
    ...
    // Add farm markers and crop info windows to the map if farms exist
    if (farmData.length > 0 && farmData[0].crops.length > 0) {
