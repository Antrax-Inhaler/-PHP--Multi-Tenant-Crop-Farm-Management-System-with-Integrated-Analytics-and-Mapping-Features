...
<div class="container-fluid">
    <form action="" id="harvest-form">
        ...
        <div class="form-group">
            ...
            <input type="date" name="HarvestedDate" id="HarvestedDate" class="form-control form-control-sm form-control-border" value="<?php echo isset($HarvestedDate) ? $HarvestedDate : ''; ?>" required>
        </div>

        <div class="form-group">
            <label for="AmountOfHarvest" class="control-label">Amount of Harvest (kg)</label>
            <input type="number" name="AmountOfHarvest" id="AmountOfHarvest" step="any" class="form-control form-control-sm form-control-border" value="<?php echo isset($AmountOfHarvest) ? $AmountOfHarvest : ''; ?>" required>
        </div>

        <div class="form-group">
            <label for="Paid" class="control-label">Paid</label>
            <select name="Paid" id="Paid" class="custom-select" required>
                <option value="1" <?= isset($Paid) && $Paid == 1 ? 'selected' : '' ?>>Yes</option>
                <option value="0" <?= isset($Paid) && $Paid == 0 ? 'selected' : '' ?>>No</option>
            </select>
        </div>
    </form>
</div>
