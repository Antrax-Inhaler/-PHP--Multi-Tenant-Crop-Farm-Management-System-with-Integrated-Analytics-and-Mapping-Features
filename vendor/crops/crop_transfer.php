...
<div id="aiResponseModal" class="modal">
    <div class="modal-content">
        ...
        <button  style="background: linear-gradient(to bottom right, #9CDC78, #74DCB0) !important;" id="saveNoteBtn" class="btn btn-secondary">Take a Note</button>
    </div>
</div>
...
<div style="display: flex;" >
<h3 id="help-scroll" >Helper Videos</h3><div class="pod-card" style="border-left-color: <?= $borderColor ?>;">
    <div class="icon">
        <img class="crop_image" src="../<?= htmlspecialchars($pest['Image1'] ?: 'uploads/alternative-pest.jpg') ?>" alt="<?= htmlspecialchars($pest['Image1'] ?: 'Alternative Image Description') ?>">
    </div>
    <div class="details">
