...
// Fetch the shop owner's name and e-signature from the database
...
<a href="javascript:void(0)" class="btn btn-flat btn-primary" id="create_new"><span class="fas fa-plus"></span>  Create New</a>
    ...
    <div class="col-md-6 offset-md-3 text-center">
        <!-- E-signature -->
         <center>        <img src="../<?= $esignature ?>"  alt="E-signature" class="img-fluid mb-3" style="max-width: 200px;   margin-bottom: -10px;">
         </center>
        <!-- Shop owner's name -->
...
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            head.find('title').text("Orders Monthly Report - Print View");
            el.append(head);
            el.append(header);
            el.append(p);
...
var footerContent = '<div class="text-center">' +
    '<img src="../<?= $esignature ?>"  alt="E-signature puta" class="img-fluid mb-3" style="max-width: 200px;   margin-bottom: -10px;">' +
    '<hr style="width: 30%; height: 5px; color: black">' +
...
<script>
    $(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Esignature',"reports/add_esignature.php",'small')
		})
    });
</script>