				...
				<tbody>
					...
					?>
						<tr>
							...
							<td data-label="Image" class="text-center"><img src="<?= validate_image($row['image_path']) ?>" alt="Product Image" class="border border-gray img-thumbnail product-img"></td>
							<td data-label="Name"><?php echo $row['name'] ?></td>
							<td data-label="Cost" class="text-right"><?php echo format_num($row['price']) ?></td>
