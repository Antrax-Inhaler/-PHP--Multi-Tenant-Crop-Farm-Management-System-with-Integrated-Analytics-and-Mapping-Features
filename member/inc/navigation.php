 ...
 <?php if ($is_verified): ?>
    ...
    <ul class="desktop-menu-category-list">
        <li class="menu-category">
            <a href="<?php echo base_url ?>./member" class="nav-link menu-title">Home</a>
        ...
        <li class="menu-category">
            <a href="<?php echo base_url ?>member/?page=crops" class="menu-title">Crop Management</a>
        </li>

        <li class="menu-category">
            <a href="<?php echo base_url ?>member/?page=financial" class="menu-title">Financial Transparency</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#">1</a>
                </li>
        ...
        <li class="menu-category">
            <a href="<?php echo base_url ?>member/?page=vendor" class="nav-link menu-title">Marketplace</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#">1</a>
                </li>
        ...
        <li class="menu-category">
            <a href="<?php echo base_url ?>member/?page=map" class="menu-title">Farm Map</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#">1</a>
                </li>
        ...
        <li class="menu-category">
        <a href="members/farm_map.php" class="menu-title">
        <a href="<?php echo base_url ?>member/?page=community" class="nav-link menu-title">Community</a>
