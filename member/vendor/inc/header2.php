...
?>
 <?php if ($is_verified): ?>
    ...
    <ul class="desktop-menu-category-list">
        ...
        <li class="menu-category">
            <a href="members/crop_management.php" class="menu-title">Crop Management</a>
        </li>
        ...
        <li class="menu-category">
            <a href="members/marketplace.php" class="menu-title">Marketplace</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#">Earrings</a>
                </li>
        ...
        <a href="<?php echo base_url ?>vendor/?page=community" class="nav-link menu-title">Community</a>
