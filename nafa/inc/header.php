  ...
  */
  ...
  <div class="index_ui">
      ...
      <div>
      <a class="dropdown-item" href="<?php echo base_url.'/classes/Login.php?f=logout_nafa' ?>"><span class="fas fa-sign-out-alt"></span> Logout</a>
      </div>
      </div>
      <div class="head2">
    ...
    <div class="dropdown-menu" role="menu">
      <a class="dropdown-item" href="<?php echo base_url.'nafa/?page=user' ?>"><span class="fa fa-user"></span> My Account</a>
...
?>
 ...
 <?php if ($is_verified): ?>
        ...
        <div class="dropdown">
    <button class="login-profile" style="background-image: url('<?php echo validate_image($_settings->userdata('image_path')) ?>');" type="button" id="dropdownButton">
        ...
        <li class="menu-category">
        <a href="<?php echo base_url ?>nafa/?page=association/index"  class="menu-title">Association</a>
        
        </li>

        <li class="menu-category">
            <a href="<?php echo base_url ?>nafa/?page=crops/index" class="menu-title">Farm Management</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#"></a>
                </li>
        ...
        <li class="menu-category">
        <a href="<?php echo base_url ?>nafa/?page=ecommerce/home" class="menu-title">Marketplace</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#"></a>
                </li>
        ...
        <li class="menu-category">
            <a href="<?php echo base_url ?>nafa/?page=map/farm-pestanddisease" class="menu-title">Farm Map</a>
            <ul class="dropdown-list">
                <li class="dropdown-item">
                    <a href="#"></a>
                </li>
        ...
        <li class="menu-category">
            <a href="<?php echo base_url ?>nafa/?page=nafa_report" class="menu-title">Reports</a>
        </li>
        <li class="menu-category">
            <a href="<?php echo base_url ?>nafa/?page=system_info" class="menu-title">Settings</a>
        </li>
    </ul>
</div>
</div>
...
<ul class="mobile-menu-category-list">
  ...
  <li class="menu-category">
  <a href="<?php echo base_url ?>nafa/?page=orders/index" class="menu-title">Farm Management</a>
  </li>
  <li class="menu-category">
  <a href="<?php echo base_url ?>nafa/?page=ecommerce/home" class="menu-title">Marketplace</a>
  </li>
  <li class="menu-category">
  <a href="<?php echo base_url ?>nafa/?page=map/map" class="menu-title">Farm Map</a>
  </li>
  <li class="menu-category">
  <a href="<?php echo base_url ?>nafa/?page=nafa_report" class="menu-title">Reports</a>
  </li>
...
<button class="action-btn">
  ...
  <a href="./" class="menu-title">  <ion-icon style="color: #000000;" name="home-outline"></ion-icon></a>

</button>

<button class="action-btn">
<a href="<?php echo base_url ?>nafa/?page=ecommerce/home" class="menu-title"><ion-icon style="color: #000000 name="bag-handle-outline"></ion-icon>
</a>
...
<button class="action-btn" data-mobile-menu-open-btn>
  ...
  <a href="<?php echo base_url ?>nafa/?page=map/map" class="menu-title">  <ion-icon style="color: #000000;" name="map-outline"></ion-icon></a>
</button>
...
<script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const dropdownSpan = document.getElementById('dropdownSpan');
      const dropdownMenu = dropdownSpan.nextElementSibling;
